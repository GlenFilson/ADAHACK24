...
plt.xlim(0,12)
plt.savefig("C:\\Users\\GlenF\\IdeaProjects\\AdaHack24\\Lib\\oneyear.jpg")
plt.clf()
...
plt.savefig("C:\\Users\\GlenF\\IdeaProjects\\AdaHack24\\Lib\\tenyears.jpg")
plt.clf()
...
plt.ylabel('Money (in £)', fontname="Arial", fontweight="bold")
plt.xlim(0,30)
plt.savefig("C:\\Users\\GlenF\\IdeaProjects\\AdaHack24\\Lib\\thirtyyears.jpg")
plt.clf()